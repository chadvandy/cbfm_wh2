...
function end_deployment_phase()
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc15_GOB_Grom_final_battle_pt_01", "subtitle_with_frame", 10, true) end, 2000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc15_GOB_Grom_final_battle_pt_02", "subtitle_with_frame", 7, true) end, 14000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc15_GOB_Grom_final_battle_pt_03", "subtitle_with_frame", 10, true) end, 23000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc15_GOB_Grom_final_battle_pt_04", "subtitle_with_frame", 12, true) end, 34000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc15_GOB_Grom_final_battle_pt_05", "subtitle_with_frame", 11, true) end, 47000);	
...
--ga_attacker_player:set_invincible_on_message("01_intro_cutscene_end", false);
--ga_enemy_city_watch:set_invincible_on_message("01_intro_cutscene_end", false);
--ga_eltharion_enemy:set_invincible_on_message("01_intro_cutscene_end", false);
