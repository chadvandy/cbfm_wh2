...
ga_ai_02_vmp_defenders = gb:get_army(gb:get_non_player_alliance_num(), 2); -- Vamps
ga_ai_02_vmp_side_attack_1 = gb:get_army(gb:get_non_player_alliance_num(), 2, "side_attack_1"); -- Vamps
ga_ai_02_vmp_side_attack_2 = gb:get_army(gb:get_non_player_alliance_num(), 2, "side_attack_2"); -- Vamps
ga_ai_02_vmp_side_attack_3 = gb:get_army(gb:get_non_player_alliance_num(), 2, "side_attack_3"); -- Vamps
...
gb:complete_objective_on_message("all_vamps_routed", "wh_main_qb_objective_attack_defeat_army", 0);
...
ga_ai_02_vmp_side_attack_1:message_on_rout_proportion("vamp_army_dead_1", 1);
ga_ai_02_vmp_side_attack_2:message_on_rout_proportion("vamp_army_dead_2", 1);
ga_ai_02_vmp_side_attack_3:message_on_rout_proportion("vamp_army_dead_3", 1);
ga_ai_02_vmp_defenders:message_on_rout_proportion("vamp_army_dead_4", 1);

gb:message_on_all_messages_received("all_vamps_routed", "vamp_army_dead_1", "vamp_army_dead_2" ,"vamp_army_dead_3", "vamp_army_dead_4")