...
local m_oxoytl_forename = "names_name_1011178559"
...
local m_starting_sanctum_regions = {
	["wh2_main_great_vortex"] = "wh2_main_vor_deadwood_the_frozen_city",
	["main_warhammer"] = "wh2_main_deadwood_the_frozen_city"
}
...
local function get_current_sanctum_stone_amount()
	...
	local stone_amount = faction:pooled_resource(m_pooled_resource_sanctum_gems):value()
	return stone_amount
end
