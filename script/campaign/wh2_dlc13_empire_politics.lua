...
local empire_politics_events = {
	["wh_main_emp_empire"] = {
		{key = "politics", turns_to_trigger = 8, turn_restriction = 1, cooldown = 2},
...
local empire_political_succession_max_loyalty = 4;
...
local empire_recently_returned_regions = {};
local empire_recently_returned_cooldown = 5;
...
local empire_authority_took_returned_region = -1;
...
local empire_prestige_event_level = 0;
...
function add_empire_politics_listeners()
	...
	for i = 1, #player_faction do
		if cm:get_faction(player_faction[i]):has_pooled_resource("emp_loyalty") == true then
	...
	core:add_listener(
		...
		function(context)
			...
			if tech == "tech_dlc13_emp_elector_counts_2" then
				for i = 1, #empire_politics_factions do
					...
					if faction:is_null_interface() == false and faction:is_human() == false and faction:is_dead() == false then
						if faction:has_pooled_resource("emp_loyalty") == true then
							empire_modify_elector_loyalty(empire_politics_factions[i].elector, "wh2_dlc13_resource_factor_technology", 1);
						end
					end
				end
			end
	...
	core:add_listener(
		...
		function(context)		
			...
			local player_name = player_faction:name();
			local player_cqi = player_faction:command_queue_index();
			cm:apply_effect_bundle("wh2_dlc13_elector_counts_bundle_hidden", player_name, 20);
			cm:faction_add_pooled_resource(player_name, "emp_prestige", "wh2_dlc13_resource_factor_events_negative", -2000);
...
function empire_new_game_setup()
	...
	empire_modify_elector_loyalty("reikland", "wh2_dlc13_resource_factor_base_fealty", 5);
	empire_modify_elector_loyalty("golden", "wh2_dlc13_resource_factor_base_fealty", 7);

	cm:apply_effect_bundle_to_region("wh2_dlc10_dark_elf_fortress_gate", "wh2_main_fort_helmgart", 0);
	...
	if karl_franz:is_null_interface() == false and karl_franz:is_human() == true then
		empire_modify_elector_loyalty("averland", "wh2_dlc13_resource_factor_base_fealty", 5);
		empire_modify_elector_loyalty("hochland", "wh2_dlc13_resource_factor_base_fealty", 6);
		empire_modify_elector_loyalty("middenland", "wh2_dlc13_resource_factor_base_fealty", 3);
		empire_modify_elector_loyalty("nordland", "wh2_dlc13_resource_factor_base_fealty", 5);
		empire_modify_elector_loyalty("ostermark", "wh2_dlc13_resource_factor_base_fealty", 4);
		empire_modify_elector_loyalty("ostland", "wh2_dlc13_resource_factor_base_fealty", 6);
		empire_modify_elector_loyalty("stirland", "wh2_dlc13_resource_factor_base_fealty", 5);
		empire_modify_elector_loyalty("talabecland", "wh2_dlc13_resource_factor_base_fealty", 7);
		empire_modify_elector_loyalty("wissenland", "wh2_dlc13_resource_factor_base_fealty", 2);
	else
		empire_modify_elector_loyalty("averland", "wh2_dlc13_resource_factor_base_fealty", 8);
		empire_modify_elector_loyalty("hochland", "wh2_dlc13_resource_factor_base_fealty", 6);
		empire_modify_elector_loyalty("middenland", "wh2_dlc13_resource_factor_base_fealty", 5);
		empire_modify_elector_loyalty("nordland", "wh2_dlc13_resource_factor_base_fealty", 5);
		empire_modify_elector_loyalty("ostermark", "wh2_dlc13_resource_factor_base_fealty", 3);
		empire_modify_elector_loyalty("ostland", "wh2_dlc13_resource_factor_base_fealty", 5);
		empire_modify_elector_loyalty("stirland", "wh2_dlc13_resource_factor_base_fealty", 4);
		empire_modify_elector_loyalty("talabecland", "wh2_dlc13_resource_factor_base_fealty", 7);
		empire_modify_elector_loyalty("wissenland", "wh2_dlc13_resource_factor_base_fealty", 2);
	end
	...
	for i = 1, #empire_politics_factions do
		...
		if is_human == false then
			...
			if faction:has_pooled_resource("emp_loyalty") == true then
				empire_modify_elector_loyalty(empire_politics_factions[i].elector, "wh2_dlc13_resource_factor_base_fealty", 5);
			end
			...
			cm:make_region_seen_in_shroud(faction_key, "wh2_main_solland_pfeildorf");
			cm:make_region_seen_in_shroud(faction_key, "wh2_main_solland_steingart");
			cm:make_region_seen_in_shroud(faction_key, "wh2_main_fort_bergbres");
			cm:make_region_seen_in_shroud(faction_key, "wh2_main_fort_helmgart");
			cm:make_region_seen_in_shroud(faction_key, "wh2_main_fort_soll");
			
			cm:make_region_seen_in_shroud(faction_key, "wh_main_the_wasteland_aarnau");
			cm:make_region_seen_in_shroud(faction_key, "wh_main_the_wasteland_gorssel");
			cm:make_region_seen_in_shroud(faction_key, "wh_main_the_wasteland_marienburg");
			cm:make_region_seen_in_shroud(faction_key, "wh_main_eastern_sylvania_castle_drakenhof");
			cm:make_region_seen_in_shroud(faction_key, "wh_main_eastern_sylvania_eschen");
			cm:make_region_seen_in_shroud(faction_key, "wh_main_eastern_sylvania_waldenhof");
			cm:make_region_seen_in_shroud(faction_key, "wh_main_western_sylvania_castle_templehof");
			cm:make_region_seen_in_shroud(faction_key, "wh_main_western_sylvania_fort_oberstyre");
			cm:make_region_seen_in_shroud(faction_key, "wh_main_western_sylvania_schwartzhafen");
			...
			cm:make_diplomacy_available(faction_key, "wh_main_vmp_vampire_counts");
	...
	if faction:has_pooled_resource("emp_loyalty") == true then
		if faction:is_human() == true then
			if cm:is_new_game() == false then
				...
				local imp_auth = faction:pooled_resource("emp_imperial_authority"):value();
				...
				if fealty_chance > 0 then
					...
					for i = 1, #empire_politics_factions do
						...
						if elector_faction:has_pooled_resource("emp_loyalty") == true then
							local fealty_value = elector_faction:pooled_resource("emp_loyalty"):value();
					...
					if #increase_list > 0 then
						for i = 1, empire_max_loyalty_increase_per_turn do
							...
							empire_modify_elector_loyalty(increase_list[rand].elector, "wh2_dlc13_resource_factor_imperial_authority_bonus", increase_list[rand].fealty);
...
function empire_award_region_prestige(faction)
	if faction:has_pooled_resource("emp_prestige") == true then
		local faction_key = faction:name();
		local region_count = faction:region_list():num_items();
		local region_prestige = region_count * empire_prestige_gain_per_region;
		cm:faction_add_pooled_resource(faction_key, "emp_prestige", "wh2_dlc13_resource_factor_regions", region_prestige);
...
function empire_process_faction(faction)
	...
	if event_triggered == false and turn_number > 60 then
		out.design("Checking for 'Prestige Dilemma'...");
		event_triggered = empire_attempt_prestige_dilemma(faction);
		out.design("\tTriggered: "..tostring(event_triggered));
	end
...
function empire_elector_rewards(faction, character)
	...
	for i = 1, #EMPIRE_ELECTOR_REWARDS do
		...
		elseif position == "wh2_main_minister_emp_reikland" and faction_key == "wh_main_emp_empire" then
			...
			local region = cm:model():world():region_manager():region_by_key("wh_main_reikland_altdorf");
			local owner = region:owning_faction();
		...
		elseif position == "wh2_main_minister_emp_solland" and faction_key == "wh2_dlc13_emp_golden_order" then
			...
			local region = cm:model():world():region_manager():region_by_key("wh2_main_solland_pfeildorf");
			local owner = region:owning_faction();
			...
			if empire_politics_factions[i].confederated == false then
				...
				if empire_politics_factions[i].dead == false then
					...
					if is_dead == true then
						...
						cm:faction_add_pooled_resource(faction_key, "emp_imperial_authority", "wh2_dlc13_resource_factor_elector_destroyed", empire_authority_elector_died);
					...
					if is_dead == false then
						...
						cm:faction_add_pooled_resource(faction_key, "emp_imperial_authority", "wh2_dlc13_resource_factor_elector_revived", empire_authority_elector_revived);
					end
				end
...
function empire_fealty_update(faction)
	for i = 1, #empire_politics_factions do
		...
		if elector:is_null_interface() == false and elector:is_dead() == false and elector:is_human() == false and elector:has_pooled_resource("emp_loyalty") == true then
			local relations = elector:diplomatic_attitude_towards(faction_key);
			local factors = elector:pooled_resource("emp_loyalty"):factors();
			local low_amount = 0;
			local high_amount = 0;
			...
			if relations >= 200 then
				cm:faction_add_pooled_resource(elector_key, "emp_loyalty", "wh2_dlc13_resource_factor_low_relations", -low_amount);
				cm:faction_add_pooled_resource(elector_key, "emp_loyalty", "wh2_dlc13_resource_factor_high_relations", -high_amount + 3);

			elseif relations >= 100 then
				cm:faction_add_pooled_resource(elector_key, "emp_loyalty", "wh2_dlc13_resource_factor_low_relations", -low_amount);
				cm:faction_add_pooled_resource(elector_key, "emp_loyalty", "wh2_dlc13_resource_factor_high_relations", -high_amount + 2);

			elseif relations >= 50 then
				cm:faction_add_pooled_resource(elector_key, "emp_loyalty", "wh2_dlc13_resource_factor_low_relations", -low_amount);
				cm:faction_add_pooled_resource(elector_key, "emp_loyalty", "wh2_dlc13_resource_factor_high_relations", -high_amount + 1);

			elseif relations <= -50 then
				cm:faction_add_pooled_resource(elector_key, "emp_loyalty", "wh2_dlc13_resource_factor_low_relations", -low_amount - 1);
				cm:faction_add_pooled_resource(elector_key, "emp_loyalty", "wh2_dlc13_resource_factor_high_relations", -high_amount);

			elseif relations <= -100 then
				cm:faction_add_pooled_resource(elector_key, "emp_loyalty", "wh2_dlc13_resource_factor_low_relations", -low_amount - 2);
				cm:faction_add_pooled_resource(elector_key, "emp_loyalty", "wh2_dlc13_resource_factor_high_relations", -high_amount);

			elseif relations <= -200 then
				cm:faction_add_pooled_resource(elector_key, "emp_loyalty", "wh2_dlc13_resource_factor_low_relations", -low_amount - 3);
				cm:faction_add_pooled_resource(elector_key, "emp_loyalty", "wh2_dlc13_resource_factor_high_relations", -high_amount);
...
function empire_region_update(faction)
	local faction_key = faction:name();

	for region_key, value in pairs(empire_recently_returned_regions) do
		if empire_recently_returned_regions[region_key].faction == faction_key then
			if empire_recently_returned_regions[region_key].cooldown > 0 then
				empire_recently_returned_regions[region_key].cooldown = empire_recently_returned_regions[region_key].cooldown - 1;
...
function empire_check_civil_war(faction)
	if faction:has_pooled_resource("emp_imperial_authority") == true then
		local value = faction:pooled_resource("emp_imperial_authority"):value();
						...
						if elector_key ~= faction_key then
							...
							if elector_faction:is_null_interface() == false and elector_faction:is_dead() == false then
								if elector_faction:is_ally_vassal_or_client_state_of(faction) == false then
									cm:force_declare_war(elector_key, faction_key, false, false, true);
									war_dec = true;

									if elector_faction:has_pooled_resource("emp_loyalty") == true then
										empire_modify_elector_loyalty(empire_politics_factions[j].elector, "wh2_dlc13_resource_factor_events_negative", -10);
									end
								end
							end
						end
...
function empire_attempt_confederation_offer(faction)
	...
	for i = 1, #empire_politics_factions do
		if empire_politics_factions[i].confederation_cooldown == 0 then
			...
			if elector_faction:is_null_interface() == false and elector_faction:is_dead() == false then
				if elector_faction:is_human() == false and elector_faction:has_pooled_resource("emp_loyalty") == true then
					local elector_cqi = elector_faction:command_queue_index();
					local loyalty = elector_faction:pooled_resource("emp_loyalty"):value();
	...
	for i = 1, #empire_politics_factions do
		if empire_politics_factions[i].succeeded == false then
			...
			if elector_faction:is_null_interface() == false and elector_faction:is_dead() == false and elector_faction:is_human() == false then
				if elector_faction:has_pooled_resource("emp_loyalty") == true and elector_faction:at_war_with(faction) == false then
					local elector_cqi = elector_faction:command_queue_index();
					local loyalty = elector_faction:pooled_resource("emp_loyalty"):value();
...
function empire_attempt_prestige_dilemma(faction)
	if faction:has_pooled_resource("emp_prestige") == true then
		local value = faction:pooled_resource("emp_prestige"):value();

		if empire_prestige_event_level == 0 and value >= 12000 then
			empire_prestige_event_level = 1;
			cm:trigger_dilemma(faction:name(), "wh2_dlc13_emp_elector_prestige_endgame_1");
			return true;
		end
	end
	return false;
	...
	for i = 1, #empire_politics_factions do
		...
		if faction:is_null_interface() == false and faction:is_dead() == false then
			if faction:is_human() == false and faction:at_war_with(player) == false then
				if faction:has_pooled_resource("emp_loyalty") == true then
					local loyalty = faction:pooled_resource("emp_loyalty"):value();
...
function empire_get_weighted_elector(player, electors, base_weight, fealty_weight, border_weight, relations_weight)
	local possible_electors = weighted_list:new();
	local nap_list = {};

	if relations_weight ~= nil then
		local nap_factions = player:factions_non_aggression_pact_with();

		for i = 0, nap_factions:num_items() - 1 do
			local nap_faction = nap_factions:item_at(i);
			local nap_faction_key = nap_faction:name();
			nap_list[nap_faction_key] = true;
		end
	end
	...
	for i = 1, #electors do
		...
		if fealty_weight ~= nil then
			if faction:has_pooled_resource("emp_loyalty") == true then
				local fealty = faction:pooled_resource("emp_loyalty"):value();
		...
		if relations_weight ~= nil then
			if nap_list[faction_key] ~= nil then
				weight = weight + relations_weight;
			end
		end
...
function empire_trigger_political_dilemma(faction, event_override)
	...
	if event_override ~= nil then
		...
		local imperial_authority = faction:pooled_resource("emp_imperial_authority"):value();
					...
					if j ~= last_event then
						...
						if event_type == last_event_type then
							...
							elseif event_type == "buy_authority" then
								...
								if imperial_authority == -9 then
									weight = weight + 35;
								elseif imperial_authority <= -5 then
									weight = weight + 30;
	...
	if event_number > 0 then
		...
		elseif event_number >= 17 and event_number <= 20 then
...
function empire_trigger_invasion_dilemma(faction, elector_override, enemy_override, region_override)
	...
	if #electors > 0 or elector_override ~= nil then
		...
		local rand_elector = empire_get_weighted_elector(faction, electors, 10, 1, 2, nil);
				...
				cm:create_force(
					...
					function(char_cqi, force_cqi)
						if enemy_faction == "wh2_dlc13_skv_skaven_invasion" then
							cm:apply_effect_bundle_to_characters_force("wh2_dlc13_elector_invasion_enemy_skaven", char_cqi, 3, true);
						else
							cm:apply_effect_bundle_to_characters_force("wh2_dlc13_elector_invasion_enemy", char_cqi, 3, true);
						end
						cm:force_declare_war(enemy_faction, faction_key, false, false, false);
						cm:force_declare_war(enemy_faction, elector_key, false, false, false);
...
function empire_spawn_human_defender_for_invasion()
	...
	if player_faction:has_home_region() then home_region_key = player_faction:home_region():name() end
	local home_pos_x, home_pos_y = cm:find_valid_spawn_location_for_character_from_settlement(faction_key, home_region_key, false, true, 1);

	if pos_x > -1 and home_pos_x > -1 then
		...
		cm:create_force(
			...
			function(char_cqi, force_cqi)
				...
				cm:teleport_to(cm:char_lookup_str(char_cqi), pos_x, pos_y, false) 
			end
		);
	end
	------------------------------------- END -------------------------------------
...
function empire_trigger_civil_war_dilemma(faction, elector_override)
	...
	if faction:has_technology("tech_dlc13_emp_elector_counts_1") == true then
	...
	if #electors > 0 or elector_override ~= nil then
		local rand_elector = empire_get_weighted_elector(faction, electors, 10, 0, 2, nil);
...
function empire_trigger_succession_dilemma(faction, elector_override, fealty_event)
	...
	if #electors > 0 or elector_override ~= nil then
		local rand_elector = empire_get_weighted_elector(faction, electors, 10, -1, 2, -9);
		local elector_key = rand_elector.faction;
...
function empire_region_occupied(context)
	...
	if reason ~= "abandoned" and reason ~= "abandoned to rebels" then
		...
		if conquerer:has_pooled_resource("emp_loyalty") == true then
				...
				if elector_faction:is_human() == false and elector_faction_key ~= conquerer_key and elector_faction:is_dead() == false then
					if conquerer:is_human() == false and conquerer:at_war_with(elector_faction) == false then
						...
						for i = 1, #human_factions do
							...
							if empire_same_turn_dilemmas == true and whose_turn:name() == player_key then
...
function empire_handle_razed_regions(cur_region)
	if cur_region == nil or (cur_region:is_province_capital() and EMPIRE_REGION_TO_ELECTOR_KEY[cur_region:name()]) then
		...
		for i = 1, #empire_politics_factions do
			...
			if faction:is_null_interface() == false and faction:is_human() == true and faction:has_pooled_resource("emp_imperial_authority") == true then
				local razed_imperial_authority = 0;
				local factors = faction:pooled_resource("emp_imperial_authority"):factors();
				...
				if amount_change ~= 0 then
					cm:faction_add_pooled_resource(faction_key, "emp_imperial_authority", "wh2_dlc13_resource_factor_regions_razed", amount_change);
				end
			end
		end
	end
...
function empire_dilemma_choice(context)
	...
	if dilemma:starts_with("wh2_dlc13_emp_elector_politics_") then
		...
		if event_number >= 1 and event_number <= 4 then
			-- Loyalty Swap
			if choice == 0 then
				empire_modify_elector_loyalty(target1, "wh2_dlc13_resource_factor_events", 1);
				empire_modify_elector_loyalty(target2, "wh2_dlc13_resource_factor_events_negative", -1);
			else
				empire_modify_elector_loyalty(target1, "wh2_dlc13_resource_factor_events_negative", -1);
				empire_modify_elector_loyalty(target2, "wh2_dlc13_resource_factor_events", 1);
			end
		elseif event_number >= 5 and event_number <= 8 then
			-- Buy Loyalty
	...
	elseif dilemma:starts_with("wh2_dlc13_demand_return_") then
		...
		if return_faction:is_null_interface() == false and return_faction:is_dead() == false then
			if choice == 0 then
				...
				cm:faction_add_pooled_resource(faction_key, "emp_imperial_authority", "wh2_dlc13_resource_factor_regions_returned", empire_authority_region_returned);
				empire_modify_elector_loyalty(conquerer, "wh2_dlc13_resource_factor_region_demand", -1);
				empire_modify_elector_loyalty(elector_key, "wh2_dlc13_resource_factor_returning_regions", 1);
			else
				empire_modify_elector_loyalty(conquerer, "wh2_dlc13_resource_factor_allowed_expansion", 1);
				empire_modify_elector_loyalty(elector_key, "wh2_dlc13_resource_factor_regions_lost", -1);
			end
		end
	...
	elseif dilemma == "wh2_dlc13_emp_elector_succeeds" or dilemma == "wh2_dlc13_emp_elector_succeeds_fealty" then
		if choice == 0 then
			cm:force_declare_war(empire_political_succession.elector_key, empire_political_succession.player_key, false, false, false);
		end
	-- CIVIL WAR
	elseif dilemma == "wh2_dlc13_emp_elector_civil_war" then
		if choice == 0 then
			cm:force_declare_war(empire_political_civil_war.elector_key_2, empire_political_civil_war.player_key, false, false, false);
			cm:force_declare_war(empire_political_civil_war.elector_key_2, empire_political_civil_war.elector_key_1, false, false, false);
			empire_modify_elector_loyalty(empire_political_civil_war.elector_key_1, "wh2_dlc13_resource_factor_events", 1);
		elseif choice == 1 then
			cm:force_declare_war(empire_political_civil_war.elector_key_1, empire_political_civil_war.player_key, false, false, false);
			cm:force_declare_war(empire_political_civil_war.elector_key_1, empire_political_civil_war.elector_key_2, false, false, false);
			empire_modify_elector_loyalty(empire_political_civil_war.elector_key_2, "wh2_dlc13_resource_factor_events", 1);
		elseif choice == 3 then
			cm:force_declare_war(empire_political_civil_war.elector_key_1, empire_political_civil_war.elector_key_2, false, false, false);
			empire_modify_elector_loyalty(empire_political_civil_war.elector_key_1, "wh2_dlc13_resource_factor_events", 1);
			empire_modify_elector_loyalty(empire_political_civil_war.elector_key_2, "wh2_dlc13_resource_factor_events_negative", -1);
		end
	-- INVASION
	elseif dilemma:starts_with("wh2_dlc13_emp_elector_invasion_") then
		...
		if choice == 0 or choice == 1 then
			...
			empire_modify_elector_loyalty(elector_key, "wh2_dlc13_resource_factor_defended_regions", 1);
		elseif choice == 2 or choice == 3 then
			empire_modify_elector_loyalty(elector_key, "wh2_dlc13_resource_factor_denied_assistance", -1);
...
function empire_occupation_decision(context)
	...
	if decision == "1799653059" then
		-- REINSTATE ELECTOR
		local region_elector = EMPIRE_REGION_TO_ELECTOR_KEY[region_key];
		
		if region_elector ~= nil then
			empire_modify_elector_loyalty(region_elector, "wh2_dlc13_resource_factor_reinstating_elector", 2);
			cm:faction_add_pooled_resource(faction_key, "emp_imperial_authority", "wh2_dlc13_resource_factor_elector_revived", empire_authority_elector_revived);
		end
		cm:callback(
			function()
	...
	elseif decision == "1252885465" then
		...
		if region_elector ~= nil then
			empire_modify_elector_loyalty(region_elector, "wh2_dlc13_resource_factor_returning_regions", 1);
		end
		cm:callback(
			function()
				local primary_slot = region:settlement():primary_slot();
...
function empire_building_created(context)
	...
	if faction:is_null_interface() == false and faction:has_pooled_resource("emp_prestige") == true then
		...
		if building_level > 0 then
			...
			cm:faction_add_pooled_resource(faction_key, "emp_prestige", "wh2_dlc13_resource_factor_buildings", prestige_reward);
			core:trigger_event("ScriptEventPrestigeGained", faction);
		end
	end
end
...
function empire_war_declared(context)
	if context:is_war() == true then
		...
		if proposer:is_human() == true and proposer:subculture() == "wh_main_sc_emp_empire" and proposer:has_pooled_resource("emp_imperial_authority") == true then
			if recipient:subculture() == "wh_main_sc_emp_empire" and recipient:has_pooled_resource("emp_loyalty") == true then
				local player = proposer:name();

				for i = 1, #empire_politics_factions do
					if empire_politics_factions[i].faction == player then
						cm:faction_add_pooled_resource(player, "emp_imperial_authority", "wh2_dlc13_resource_factor_declared_war", empire_authority_elector_war);
						break;
					end
				end

				local elector = recipient:name();
				empire_modify_elector_loyalty(elector, "wh2_dlc13_resource_factor_declared_war", empire_loyalty_war_loss);
		...
		if attacker_won == true then
			...
			for i = 1, cm:pending_battle_cache_num_attackers() do
				...
				if already_awarded[attacker_name] == nil then
					...
					if attacker:is_null_interface() == false and attacker:has_pooled_resource("emp_prestige") == true then
						...
						cm:faction_add_pooled_resource(attacker_name, "emp_prestige", "wh2_dlc13_resource_factor_battles", prestige_reward);
		...
		elseif defender_won == true then
			...
			for i = 1, cm:pending_battle_cache_num_defenders() do
				...
				if already_awarded[defender_name] == nil then
					...
					if defender:is_null_interface() == false and defender:has_pooled_resource("emp_prestige") == true then
						local prestige_reward = defender_prestige * empire_prestige_kill_income_mod;
						if prestige_reward > empire_prestige_kill_income_cap then
							prestige_reward = empire_prestige_kill_income_cap;
						end
						prestige_reward = math.ceilTo(prestige_reward, 10);
						cm:faction_add_pooled_resource(defender_name, "emp_prestige", "wh2_dlc13_resource_factor_battles", prestige_reward);
...
function empire_modify_elector_loyalty(elector_count, factor, value)
	if elector_count ~= nil then
		...
		if EMPIRE_ELECTOR_COUNTS[elector_count] ~= nil then
			...
			if faction:is_null_interface() == false and faction:has_pooled_resource("emp_loyalty") == true then
				cm:faction_add_pooled_resource(faction_key, "emp_loyalty", factor, value);
				local loyalty = faction:pooled_resource("emp_loyalty"):value();
		...
		if value >= 1 then
			if factor ~= "wh2_dlc13_resource_factor_imperial_authority_bonus" and factor ~= "wh2_dlc13_resource_factor_imperial_authority_negative" then
				if factor ~= "wh2_dlc13_resource_factor_high_relations" and factor ~= "wh2_dlc13_resource_factor_low_relations" then
					for i = 1, #empire_politics_factions do
...
function empire_calculate_average_fealty()
	...
	for i = 1, #empire_politics_factions do
		...
		if faction:is_null_interface() == false and faction:is_dead() == false and faction:is_human() == false and faction:has_pooled_resource("emp_loyalty") == true then
			total_electors = total_electors + 1;
			total_fealty = total_fealty + faction:pooled_resource("emp_loyalty"):value();
		end
	end
...
function empire_setup_invasion_armies()
	...
	random_army_manager:add_mandatory_unit("electors_norsca_major_1", "wh_main_nor_inf_chaos_marauders_0", 3);
	random_army_manager:add_mandatory_unit("electors_norsca_major_1", "wh_dlc08_nor_inf_marauder_spearman_0", 4);
	random_army_manager:add_mandatory_unit("electors_norsca_major_1", "wh_dlc08_nor_inf_marauder_hunters_0", 3);
	...
	random_army_manager:add_mandatory_unit("electors_norsca_major_2", "wh_main_nor_inf_chaos_marauders_0", 4);
	random_army_manager:add_mandatory_unit("electors_norsca_major_2", "wh_dlc08_nor_inf_marauder_spearman_0", 3);
	random_army_manager:add_mandatory_unit("electors_norsca_major_2", "wh_dlc08_nor_inf_marauder_hunters_0", 3);
	...
	random_army_manager:add_mandatory_unit("electors_norsca_major_3", "wh_main_nor_inf_chaos_marauders_0", 4);
	random_army_manager:add_mandatory_unit("electors_norsca_major_3", "wh_dlc08_nor_inf_marauder_spearman_0", 3);
	random_army_manager:add_mandatory_unit("electors_norsca_major_3", "wh_dlc08_nor_inf_marauder_hunters_0", 3);
	...
	random_army_manager:add_mandatory_unit("electors_norsca_major_4", "wh_dlc08_nor_inf_marauder_champions_0", 1);
	random_army_manager:add_mandatory_unit("electors_norsca_major_4", "wh_main_nor_inf_chaos_marauders_0", 4);
	random_army_manager:add_mandatory_unit("electors_norsca_major_4", "wh_dlc08_nor_inf_marauder_spearman_0", 4);
	random_army_manager:add_mandatory_unit("electors_norsca_major_4", "wh_dlc08_nor_inf_marauder_hunters_0", 3);
	...
	random_army_manager:add_mandatory_unit("electors_norsca_major_5", "wh_dlc08_nor_inf_marauder_champions_0", 2);
	random_army_manager:add_mandatory_unit("electors_norsca_major_5", "wh_main_nor_inf_chaos_marauders_0", 4);
	random_army_manager:add_mandatory_unit("electors_norsca_major_5", "wh_dlc08_nor_inf_marauder_spearman_0", 3);
	random_army_manager:add_mandatory_unit("electors_norsca_major_5", "wh_dlc08_nor_inf_marauder_hunters_0", 3);
...
cm:add_saving_game_callback(
	function(context)
		...
		cm:save_named_value("empire_recently_returned_regions", empire_recently_returned_regions, context);
		cm:save_named_value("empire_prestige_event_level", empire_prestige_event_level, context);
	end
);
cm:add_loading_game_callback(
	function(context)
		if cm:is_new_game() == false then
			...
			empire_recently_returned_regions = cm:load_named_value("empire_recently_returned_regions", empire_recently_returned_regions, context);
			empire_prestige_event_level = cm:load_named_value("empire_prestige_event_level", empire_prestige_event_level, context);
		end
	end
);

EMPIRE_ELECTOR_COUNTS = {
	["averland"] = {capital = "wh_main_averland_averheim", faction_key = "wh_main_emp_averland"},
	["reikland"] = {capital = "wh_main_reikland_altdorf", faction_key = "wh_main_emp_empire"},
	["hochland"] = {capital = "wh_main_hochland_hergig", faction_key = "wh_main_emp_hochland"},
	["middenland"] = {capital = "wh_main_middenland_middenheim", faction_key = "wh_main_emp_middenland"},
	["nordland"] = {capital = "wh_main_nordland_salzenmund", faction_key = "wh_main_emp_nordland"},
	["ostermark"] = {capital = "wh_main_ostermark_bechafen", faction_key = "wh_main_emp_ostermark"},
	["ostland"] = {capital = "wh_main_ostland_wolfenburg", faction_key = "wh_main_emp_ostland"},
...
EMPIRE_REGION_TO_ELECTOR_KEY = {
	["wh_main_averland_averheim"] = "averland",
	["wh_main_averland_grenzstadt"] = "averland",
	["wh_main_hochland_brass_keep"] = "hochland",
	["wh_main_hochland_hergig"] = "hochland",
	["wh_main_middenland_carroburg"] = "middenland",
	["wh_main_middenland_middenheim"] = "middenland",
	["wh_main_middenland_middenstag"] = "middenland",
	["wh_main_middenland_weismund"] = "middenland",
	["wh_main_nordland_dietershafen"] = "nordland",
	["wh_main_nordland_salzenmund"] = "nordland",
	["wh_main_ostermark_bechafen"] = "ostermark",
	["wh_main_ostermark_essen"] = "ostermark",
	["wh_main_ostermark_mordheim"] = "ostermark",
	["wh_main_ostermark_nagenhof"] = "ostermark",
	["wh_main_ostland_castle_von_rauken"] = "ostland",
	["wh_main_ostland_norden"] = "ostland",
	["wh_main_ostland_wolfenburg"] = "ostland",
	["wh_main_reikland_altdorf"] = "reikland",
	["wh_main_reikland_eilhart"] = "reikland",
	["wh_main_reikland_grunburg"] = "reikland",
	["wh_main_reikland_helmgart"] = "reikland",
	["wh_main_stirland_flensburg"] = "stirland",
	["wh_main_stirland_niedling"] = "stirland",
	["wh_main_stirland_wurtbad"] = "stirland",
	["wh_main_stirland_the_moot"] = "stirland",
	["wh_main_talabecland_kappelburg"] = "talabecland",
	["wh_main_talabecland_kemperbad"] = "talabecland",
	["wh_main_talabecland_krugenheim"] = "talabecland",
...
EMPIRE_ELECTOR_REWARDS = {
	{position = "wh2_main_minister_emp_averland", region = "wh_main_averland_averheim", unit = "wh2_dlc13_emp_cav_pistoliers_ror_0", ancillary = "wh2_dlc13_anc_weapon_runefang_averland"},
	{position = "wh2_main_minister_emp_hochland", region = "wh_main_hochland_hergig", unit = "wh2_dlc13_emp_inf_handgunners_ror_0", ancillary = "wh2_dlc13_anc_weapon_runefang_hochland"},
	{position = "wh2_main_minister_emp_middenland", region = "wh_main_middenland_middenheim", unit = "wh2_dlc13_emp_inf_swordsmen_ror_0", ancillary = "wh2_dlc13_anc_weapon_runefang_middenland"},
	{position = "wh2_main_minister_emp_nordland", region = "wh_main_nordland_salzenmund", unit = "wh2_dlc13_emp_inf_halberdiers_ror_0", ancillary = "wh2_dlc13_anc_weapon_runefang_nordland"},
	{position = "wh2_main_minister_emp_ostermark", region = "wh_main_ostermark_bechafen", unit = "wh2_dlc13_emp_cav_empire_knights_ror_0", ancillary = "wh2_dlc13_anc_weapon_runefang_ostermark"},
	{position = "wh2_main_minister_emp_ostland", region = "wh_main_ostland_wolfenburg", unit = "wh2_dlc13_emp_cav_empire_knights_ror_2", ancillary = "wh2_dlc13_anc_weapon_runefang_ostland"},
	{position = "wh2_main_minister_emp_reikland", region = "wh_main_reikland_altdorf", unit = "wh2_dlc13_emp_inf_greatswords_ror_0", ancillary = "wh2_dlc13_anc_weapon_runefang_reikland"},
	{position = "wh2_main_minister_emp_solland", region = "wh2_main_solland_pfeildorf", unit = "wh2_dlc13_emp_inf_spearmen_ror_0", ancillary = "wh2_dlc13_anc_weapon_runefang_solland"},
	{position = "wh2_main_minister_emp_stirland", region = "wh_main_stirland_wurtbad", unit = "wh2_dlc13_emp_inf_crossbowmen_ror_0", ancillary = "wh2_dlc13_anc_weapon_runefang_stirland"},
	{position = "wh2_main_minister_emp_sylvania", region = "wh_main_eastern_sylvania_castle_drakenhof", unit = "wh2_dlc13_emp_cav_empire_knights_ror_1", ancillary = "wh2_dlc13_anc_talisman_sylvania_journal"},
	{position = "wh2_main_minister_emp_talabecland", region = "wh_main_talabecland_talabheim", unit = "wh2_dlc13_emp_art_mortar_ror_0", ancillary = "wh2_dlc13_anc_weapon_runefang_talabecland"},
	{position = "wh2_main_minister_emp_wasteland", region = "wh_main_the_wasteland_marienburg", unit = "wh2_dlc13_emp_cav_outriders_ror_0", ancillary = "wh2_dlc13_anc_talisman_stadsraad_key"},
	{position = "wh2_main_minister_emp_wissenland", region = "wh_main_wissenland_nuln", unit = "wh2_dlc13_emp_veh_steam_tank_ror_0", ancillary = "wh2_dlc13_anc_weapon_runefang_wissenland"}
};
