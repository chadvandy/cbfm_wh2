function sm0_horde()
	core:add_listener(
		...
		function(context)
			...
			for i = 0, character_list:num_items() - 1 do
				...
				if character:has_military_force() and character:military_force():force_type():key() ~= "ARMY" then
    ...
    core:add_listener(
		...
		function(context)
            ...
            and context:military_force_created():faction():name() ~= "wh2_dlc13_lzd_spirits_of_the_jungle" and context:military_force_created():force_type():key() ~= "ARMY"
		end,
		function(context)
